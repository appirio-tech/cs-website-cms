...
$(document).ready(function() {
    ...
    function resize(){
        ...
        $('.switch').css({height:$('.switch .item').height()+5})
...
//        footSocialLinks.detach().appendTo('.footer-wrapper .row-fluid').addClass('social-links');
        ...
        equalHeight($('.switch .item li.span4'));
        ...
        var api = $('.quotes .scrollable').data('scrollable');
        if(api) {
            var currentSlide = api.getIndex();
            api.seekTo(currentSlide, 0);
        }
    }
});
